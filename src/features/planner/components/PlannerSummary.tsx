          ...
          <div>
            ...
            <ul className="planner-summary__list">
              <li className="planner-summary__item">
                ...
                <span className="planner-summary__name" style={{ color: 'var(--planner-text-subtle)' }}>강의 없음</span>
                <span className="planner-summary__duration" style={{ color: 'var(--planner-text-subtle)' }}>0분</span>
              </li>
            </ul>
          </div>
          <div>
              ...
              <ResponsiveContainer width="100%" height={34}>
                ...
                >
                  ...
                  <YAxis
                    ...
                    dataKey="name"
                    width={24}
                    tick={({ x, y }: { x: string | number; y: string | number }) => (
